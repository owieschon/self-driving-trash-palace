...
Caretaker needs compact instructions, developers need executable contracts, and reviewers need durable evidence. Copying the same behavior into policy prose, agent references, docs, and receipts would let those surfaces drift.
