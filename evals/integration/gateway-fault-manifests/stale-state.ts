...
export const STALE_STATE_GATEWAY_FAULT_MANIFEST = GatewayFaultDurableOutcomeManifestSchema.parse({
  schemaVersion: 'gateway-fault-durable-outcome@1',
  id: 'gateway-fault-stale_state-post-preheat@1',
  fixtureId: 'night-shift-homecoming@1',
  observationPoint: 'post_preheat_callback_ingested',
  faultProfile: 'stale_state',
  injection: { kind: 'stale_state', staleByVirtualMilliseconds: 10_000 },
  recoverability: {
    scope: 'current_preheat_gateway_effect',
    classification: 'recoverable',
    outcomeAtObservationPoint: 'completed_with_stale_evidence',
    mechanism: 'stale_evidence_retained_for_verification',
  },
  terminalOutcome: {
    expected: null,
