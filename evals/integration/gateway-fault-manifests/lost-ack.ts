...
export const LOST_ACK_GATEWAY_FAULT_MANIFEST = GatewayFaultDurableOutcomeManifestSchema.parse({
  schemaVersion: 'gateway-fault-durable-outcome@1',
  id: 'gateway-fault-lost_ack-post-preheat@1',
  fixtureId: 'night-shift-homecoming@1',
  observationPoint: 'post_preheat_callback_ingested',
  faultProfile: 'lost_ack',
  injection: { kind: 'lost_ack', callbackDelayVirtualMilliseconds: 0 },
  recoverability: {
  ...
  expectedDurableState: {
    ...
    effect: {
      ...
      dispatchUnknownReason: 'lost_ack',
