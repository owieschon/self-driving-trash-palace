...
export const NONE_GATEWAY_FAULT_MANIFEST = GatewayFaultDurableOutcomeManifestSchema.parse({
  schemaVersion: 'gateway-fault-durable-outcome@1',
  id: 'gateway-fault-none-post-preheat@1',
  ...
  recoverability: {
    ...
    outcomeAtObservationPoint: 'completed_without_fault',
    mechanism: 'normal_delivery',
  },
  terminalOutcome: {
    expected: null,
